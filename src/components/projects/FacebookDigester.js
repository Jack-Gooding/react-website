...
import jChars from "../../images/projects/facebook-digest/james-o.svg";
import fChars from "../../images/projects/facebook-digest/francesca-o.svg";

export default class FacebookDigester extends React.Component {
  render() {
    return (
